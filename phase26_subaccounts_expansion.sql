-- Phase 26: Sub-Accounts Chart of Accounts Expansion & Seeding
-- Seeding Owner Drawings, Retained Earnings, Fixed Assets - Office/Equipment, and Long-Term Loan Payable
...
-- Seed for all existing distinct users
DO $$
DECLARE
  r RECORD;
BEGIN
  FOR r IN SELECT DISTINCT user_id FROM accounts WHERE user_id IS NOT NULL LOOP
