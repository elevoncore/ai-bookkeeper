...
export default function TransactionsExplorer({ transactions }: TransactionsExplorerProps) {
 ...
 className="w-full px-4 py-2.5 min-h-[44px] text-xs sm:text-sm bg-white border border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all font-medium"
 />
 </div>
 ...
 <div className="flex items-center justify-end gap-1">Amount</div>
 </th>
 </tr>
 </thead>
 ...
 className="px-3 py-1.5 rounded-lg hover:bg-slate-100 disabled:opacity-40 cursor-pointer min-h-[36px] flex items-center justify-center font-semibold text-xs text-slate-700 focus-visible:ring-2 focus-visible:ring-blue-500"
