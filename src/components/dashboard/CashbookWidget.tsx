...
export default function CashbookWidget({ onOpenAddAccount, onOpenAdjustBalance, onOpenTransferCash }: CashbookWidgetProps) {
 ...
 className="px-3 py-2 text-xs font-bold min-h-[44px] flex items-center justify-center rounded-xl bg-white/90 hover:bg-white text-slate-500 hover:text-slate-900 border border-slate-200 transition-all cursor-pointer shrink-0 shadow-xs focus-visible:ring-2 focus-visible:ring-blue-500"
