      ...
      <div className="flex items-center justify-between min-w-0">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <h3 className="font-bold text-sm text-gray-900 flex items-center gap-2 truncate">
              Cash & Bank Balances
            </h3>
            <p className="text-xs text-gray-500 truncate">Real-time liquid cashbook position</p>
          </div>
        </div>
        ...
        <button
          ...
          className="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-gray-400 hover:text-gray-700 hover:bg-gray-100/50 transition-all cursor-pointer shrink-0"
      ...
      {isLoading ? (
        ...
        <div className="space-y-4 min-w-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0">
            ...
            <div className="p-4 rounded-xl border border-blue-100 bg-blue-50/40 flex items-center justify-between min-w-0 gap-3">
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-8 h-8 rounded-lg bg-blue-500 text-white flex items-center justify-center font-bold shrink-0">
                  <Building2 className="w-4 h-4" />
                </div>
                <div className="min-w-0">
                  <span className="text-xs font-semibold text-gray-600 block truncate">Main Bank Account</span>
            ...
            {/* Petty Cash Card */}
            <div className="p-4 rounded-xl border border-emerald-100 bg-emerald-50/40 flex items-center justify-between min-w-0 gap-3">
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-8 h-8 rounded-lg bg-emerald-500 text-white flex items-center justify-center font-bold shrink-0">
                  <Coins className="w-4 h-4" />
                </div>
                <div className="min-w-0">
                  <span className="text-xs font-semibold text-gray-600 block truncate">Petty Cash</span>
                  <p className="text-base sm:text-lg font-black text-gray-900 mt-0.5 truncate">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center px-4 py-3 rounded-xl bg-gray-900 text-white shadow-sm min-w-0 gap-1 sm:gap-4">
            <span className="text-xs font-medium text-gray-300 truncate">Total Liquid Cash Available</span>
            <span className="text-sm sm:text-base font-black text-emerald-400 truncate">
