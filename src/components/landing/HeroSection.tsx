        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start text-left space-y-7">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#111827] dark:text-white tracking-tight leading-[1.08] font-sans"
            >
              Next-Generation <br />
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-[#4B5563] dark:text-slate-300 leading-relaxed max-w-lg font-medium"
            >
            ...
            >
              ...
              <button 
                ...
                className="inline-flex justify-center items-center px-7 py-3.5 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold text-base rounded-full border-2 border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-200 cursor-pointer shadow-xs"
              >
                Explore Features
              </button>
            </motion.div>
          ...
          >
            ...
            <div className="relative w-full rounded-2xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl overflow-hidden transition-all duration-300">
              
              {/* Window Control Bar */}
              <div className="px-4 py-2.5 bg-slate-100/90 dark:bg-slate-800/90 border-b border-slate-200/80 dark:border-slate-700/80 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-rose-400" />
                  <div className="w-3 h-3 rounded-full bg-amber-400" />
                  <div className="w-3 h-3 rounded-full bg-emerald-400" />
                </div>
                <div className="flex items-center gap-2 px-3 py-0.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-[11px] font-medium text-slate-500 dark:text-slate-400 shadow-2xs">
                  <span className="w-2 h-2 rounded-full bg-emerald-500" />
                  <span>app.inscribe.ai/dashboard</span>
                </div>
                <div className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider hidden sm:block">
                  Live System
                </div>
              </div>

              {/* Realistic Real App Screenshot Panel */}
              <div className="relative w-full aspect-[16/9] bg-slate-50 dark:bg-slate-950 overflow-hidden">
                <Image
