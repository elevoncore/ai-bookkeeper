...
export async function POST(request: Request) {
 ...
 p_user_id: user.id
  ...
  // Ensure all standard system accounts exist (including Advances & Sub-Accounts)
  const accountsToSeed = [
    ...
    { user_id: user.id, name: 'Supplier Advances / Prepaid Expenses', type: 'asset', is_system: true, is_cash_account: false },
    ...
    { user_id: user.id, name: 'Customer Advances / Unearned Revenue', type: 'liability', is_system: true, is_cash_account: false },
    { user_id: user.id, name: 'Sales Tax Payable', type: 'liability', is_system: true, is_cash_account: false },
    { user_id: user.id, name: 'Short-Term Debt', type: 'liability', is_system: true, is_cash_account: false },
    { user_id: user.id, name: 'Long-Term Debt', type: 'liability', is_system: true, is_cash_account: false },
    { user_id: user.id, name: 'Owner\'s Capital', type: 'equity', is_system: true, is_cash_account: false },
    { user_id: user.id, name: 'Owner\'s Drawings', type: 'equity', is_system: true, is_cash_account: false },
